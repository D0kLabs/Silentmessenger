...
public abstract class MaskableEnvelopeEntry
    extends gnu.javax.crypto.keyring.EnvelopeEntry
{
  /** The masked state. */
  ...
  public void add(gnu.javax.crypto.keyring.Entry entry)
  {
    if (isMasked())
  ...
  public boolean containsEntry(gnu.javax.crypto.keyring.Entry entry)
  {
    if (isMasked())
      throw new IllegalStateException("masked envelope");
  ...
  public boolean remove(gnu.javax.crypto.keyring.Entry entry)
  {
    if (isMasked())
      throw new IllegalStateException("masked envelope");
