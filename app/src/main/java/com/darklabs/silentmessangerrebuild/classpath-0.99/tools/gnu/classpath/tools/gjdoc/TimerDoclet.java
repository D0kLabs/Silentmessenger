...
public class TimerDoclet {
   ...
   public static boolean validOptions(String[][] options, DocErrorReporter reporter)
      ...
      init();
      return ((Boolean)doclet.getClass().getMethod("validOptions", String[][].class, DocErrorReporter.class).invoke(null, new Object[]{options, reporter})).booleanValue();
      //return false; //doclet.validOptions(options, reporter);
   }

   public static int optionLength(String option) throws Exception {
      init();
      return ((Integer)doclet.getClass().getMethod("optionLength", String.class).invoke(null, new Object[]{option})).intValue();
   }
   ...
   public static boolean start(RootDoc root) throws Exception {
      ...
      if (validOptions(root.options(), root)) {
         doclet.getClass().getMethod("start", RootDoc.class).invoke(null, new Object[]{root});
      }
      runMemThread=false;
      Timer.setStopTime();
      synchronized (TimerDoclet.class) {
