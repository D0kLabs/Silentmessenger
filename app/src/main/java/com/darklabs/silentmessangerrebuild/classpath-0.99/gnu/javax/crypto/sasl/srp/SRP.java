...
public final class SRP
{
  ...
  {
    return digest(src.getBytes(StandardCharsets.US_ASCII));
  }
  ...
  public byte[] computeX(final byte[] s, final String user,
      ...
      throws UnsupportedEncodingException
  {
    return computeX(s, user.getBytes(StandardCharsets.US_ASCII), password.getBytes(StandardCharsets.US_ASCII));
  }

  public byte[] computeX(final byte[] s, final String user, final byte[] p)
      throws UnsupportedEncodingException
  {
    return computeX(s, user.getBytes(StandardCharsets.US_ASCII), p);
  }
